...
public class DateUtils {
     ...
     * @return
     */
    public long getCurrentTimeByMilliSecond() {
    ...
    public long get3DaysAgoTimestamp() {
        return getCurrentTimeByMilliSecond() - 3 * 24 * 3600;
    }
    ...
    public long getDaysAgoTimestamp(int days) {
        return getCurrentTimeByMilliSecond() - days * 24 * 3600;
    }
    ...
    public long getCurrentTimeTrunkMinutes() {
        ...
        long currentTimeWithoutMinutes = timestamp.getTime() ;
    ...
    public long getCurrentTimeTrunkHours() {
        ...
        long currentTimeWithoutHours = timestamp.getTime() ;
    ...
    public String formatSecondsToHM(long timeStamp) {
        Date date = new Date(timeStamp );
    ...
    public String getCurrentMonthDash() {
        Date date = new Date(System.currentTimeMillis());
        DateFormat formatter = new SimpleDateFormat("YYYY-MM");
        String dateFormatted = formatter.format(date);
        return dateFormatted;
    ...
    public LocalDateTime convertUnixTimestampToLocalDateTime(long unixTimestamp) {
        // Convert Unix timestamp to Instant
        Instant instant = Instant.ofEpochMilli(unixTimestamp);
        // Convert Instant to LocalDateTime using a specific time zone (e.g., ZoneId.of("UTC"))
