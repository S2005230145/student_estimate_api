...
public class ClassTeacherRelationController extends BaseSecurityController
 { 
// POST    /v2/p/class_teacher_relation/new/    controllers.business.ClassTeacherRelationController.addClassTeacherRelation(request: Request)
// GET     /v2/p/class_teacher_relation/:id/    controllers.business.ClassTeacherRelationController.getClassTeacherRelation(request: Request,id:Long)
// POST    /v2/p/class_teacher_relation/:id/    controllers.business.ClassTeacherRelationController.updateClassTeacherRelation(request: Request,id:Long)
// POST    /v2/p/class_teacher_relation/        controllers.business.ClassTeacherRelationController.deleteClassTeacherRelation(request: Request)
// GET     /v2/p/class_teacher_relation_list/   controllers.business.ClassTeacherRelationController.listClassTeacherRelation(request: Request,page:Int?=1,filter:String?="",status:Int?=0)
...
classTeacherRelation.setUpdateTime(currentTimeBySecond);classTeacherRelation.save(); 
return okJSON200();
});
}/**
...
ClassTeacherRelation            newClassTeacherRelation = Json.fromJson(jsonNode, ClassTeacherRelation.class);
 ...
 if (newClassTeacherRelation.classId>0) originalClassTeacherRelation.setClassId(newClassTeacherRelation.classId); 
 if (newClassTeacherRelation.teacherId>0) originalClassTeacherRelation.setTeacherId(newClassTeacherRelation.teacherId); 
 if (!ValidationUtil.isEmpty(newClassTeacherRelation.subject)) originalClassTeacherRelation.setSubject(newClassTeacherRelation.subject); 
 if (newClassTeacherRelation.isHeadTeacher!=originalClassTeacherRelation.isHeadTeacher) originalClassTeacherRelation.setIsHeadTeacher(newClassTeacherRelation.isHeadTeacher); 
 if (newClassTeacherRelation.updateTime>0) originalClassTeacherRelation.setUpdateTime(newClassTeacherRelation.updateTime); 
long currentTimeBySecond = dateUtils.getCurrentTimeByMilliSecond();
originalClassTeacherRelation.setUpdateTime(currentTimeBySecond); originalClassTeacherRelation.save();
            return okJSON200();
        });
}
/**
