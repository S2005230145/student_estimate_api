...
public class BusinessConstant {
    ...
    public static final int ONE_DAY_MILLI_SECOND = 24 * 3600 * 1000;
    public static final int TIANSHE_ORG_ID = 1002;
     ...
     * 支付方式,11定金支付
     */
    public static final int PAYMENT_PRE_PAY = 11;

    public static final int PAYMENT_SCAN_BARCODE_PAY = 100;
    public static final int PAYMENT_SCAN_BARCODE_PAY_WE_PAY = 101;//微信扫码
    public static final int PAYMENT_SCAN_BARCODE_PAY_ALI_PAY = 102;//支付宝扫码
    ...
    public static final String OPERATION_TRANSFER_TO_BALANCE = "OPERATION_TRANSFER_TO_BALANCE";
    public static final String OPERATION_SET_USER_AUTH = "OPERATION_SET_USER_AUTH";
    public static final String OPERATION_AUTH_SHOP = "OPERATION_AUTH_SHOP";
    /**
     * 支付订单
     */
     ...
     * 退款
     */
    public static final String OPERATION_USE_SERVICE = "OPERATION_USE_SERVICE";

    public static final String OPERATION_CONFIRM_PICK_UP = "OPERATION_CONFIRM_PICK_UP";
    /**
     * 提现
     */
    ...
    public static final int TRANSACTION_TYPE_POS_CONSUME = 4;
    /**
     * 交易类型,交易扣除
     */
    ...
    public static final int TRANSACTION_TYPE_WITHDRAW_DENY_REFUND = 17;
    public static final int TRANSACTION_TYPE_AGREE_WITHDRAW = 18;
    ...
    public static final int TRANSACTION_TYPE_CANCEL_DEPOSIT = 62;
    ...
    public static final int TRANSACTION_TYPE_ORDER_AWARD_TO_BALANCE = 103;
    public static final int TRANSACTION_TYPE_SCORE_TO_COUPON = 108;


    public static final int TRANSACTION_TYPE_BATCH_IMPORT = 110;
    public static final int TRANSACTION_TYPE_BATCH_IMPORT_FIX = 111;
    public static final int TRANSACTION_TYPE_OPERATE_BALANCE = 112;

    public static final int TRANSACTION_TYPE_AWARD_INVITE = 120;
    ...
    //公司名字
    public static final String PARAM_KEY_COMPANY_NAME = "PARAM_KEY_COMPANY_NAME";
    public static final String PARAM_KEY_CONTACT_NAME = "PARAM_KEY_CONTACT_NAME";
    public static final String PARAM_KEY_CONTACT_PHONE_NUMBER = "PARAM_KEY_CONTACT_PHONE_NUMBER";
    public static final String PARAM_KEY_CONTACT_POST_CODE = "PARAM_KEY_CONTACT_POST_CODE";
    public static final String PARAM_KEY_CONTACT_PROVINCE = "PARAM_KEY_CONTACT_PROVINCE";
    public static final String PARAM_KEY_CONTACT_CITY = "PARAM_KEY_CONTACT_CITY";
    public static final String PARAM_KEY_CONTACT_AREA = "PARAM_KEY_CONTACT_AREA";
    public static final String PARAM_KEY_CONTACT_ADDRESS = "PARAM_KEY_CONTACT_ADDRESS";
    ...
    //股权总数
    public static final String PARAM_KEY_TOTAL_SHARE = "PARAM_KEY_TOTAL_SHARE";
    //已分配股权
    public static final String PARAM_KEY_SHARE_ALREADY_RELEASE = "PARAM_KEY_SHARE_ALREADY_RELEASE";

    //直接推广上级抽成比例
    public static final String PARAM_KEY_MASTER_COMMISSION_RATIO = "PARAM_KEY_MASTER_COMMISSION_RATIO";
    //推广上上级抽成比例
    public static final String PARAM_KEY_MASTER_MASTER_COMMISSION_RATIO = "PARAM_KEY_MASTER_MASTER_COMMISSION_RATIO";
    //购买的积分返现
    public static final String PARAM_KEY_ORDER_RETURN_COMMISSION_RATIO = "PARAM_KEY_ORDER_RETURN_COMMISSION_RATIO";
    //团队返现比例
    public static final String PARAM_KEY_PLATFORM_COMMISSION_RATIO = "PARAM_KEY_PLATFORM_COMMISSION_RATIO";
    public static final String PARAM_KEY_TIME_STAMP_INSTANCE = "PARAM_KEY_TIME_STAMP_INSTANCE";
    ...
    public static final String CARD_COUPON_SYSTEM_GIVE_CODE = "SYSTEM_GIVE";
    ...
    public static final String PARAM_KEY_ALIPAY_ALI_PUBLIC_KEY_RSA2 = "PARAM_KEY_ALIPAY_ALI_PUBLIC_KEY_RSA2";
    ...
    public static final String PARAM_KEY_COS_SECRET_ID = "PARAM_KEY_COS_SECRET_ID";
    public static final String PARAM_KEY_COS_SECRET_KEY = "PARAM_KEY_COS_SECRET_KEY";

    public static final String OPERATION_DEPOSIT_SUBTRACT = "OPERATION_DEPOSIT_SUBTRACT";
    public static final String OPERATION_BATCH_UPDATE_CONVOY_STATION_PRICE = "OPERATION_BATCH_UPDATE_CONVOY_STATION_PRICE";

    public static final String PARAM_KEY_FEIE_PRINTER_KEY = "PARAM_KEY_FEIE_PRINTER_KEY";

    public static final String OPERATION_BATCH_ADD_TABLE = "OPERATION_BATCH_ADD_TABLE";


    public static final String PARAM_KEY_ALI_PAY_PRIVATE_KEY = "PARAM_KEY_ALI_PAY_PRIVATE_KEY";
    public static final String PARAM_KEY_ALI_PAY_PUBLIC_KEY = "PARAM_KEY_ALI_PAY_PUBLIC_KEY";
    public static final String PARAM_KEY_ALI_PAY_ALI_PUBLIC_KEY = "PARAM_KEY_ALI_PAY_ALI_PUBLIC_KEY";
    public static final String PARAM_KEY_ALI_PAY_AGENT = "PARAM_KEY_ALI_PAY_AGENT";
    public static final String PARAM_KEY_ALI_SYS_SERVICE_PROVIDER_ID = "PARAM_KEY_ALI_SYS_SERVICE_PROVIDER_ID";

    public static final String PARAM_KEY_WE_PAY_API_V2_KEY = "PARAM_KEY_WE_PAY_API_V2_KEY";

    public static final String PARAM_KEY_MEMBER_DAY = "PARAM_CONFIG_KEY_PREFIX:PARAM_KEY_MEMBER_DAY";
    public static final String PARAM_KEY_MEMBER_DISCOUNT = "PARAM_CONFIG_KEY_PREFIX:PARAM_KEY_MEMBER_DISCOUNT";
    public static final String PARAM_KEY_MEMBER_BIRTHDAY_DISCOUNT = "PARAM_CONFIG_KEY_PREFIX:PARAM_KEY_MEMBER_BIRTHDAY_DISCOUNT";
    public static final String PARAM_KEY_STAT_MEMBER = "PARAM_KEY_STAT_MEMBER";
    public static final String PARAM_KEY_SMS_BUSINESS_SMSID = "PARAM_KEY_SMS_BUSINESS_SMSID";
    public static final String PARAM_KEY_SMS_BUSINESS_TEMPLATE_ID = "PARAM_KEY_SMS_BUSINESS_TEMPLATE_ID";
    public static final String OPERATION_RELEASE_MEMBER_CARD = "OPERATION_RELEASE_MEMBER_CARD";
    public static final String PARAM_KEY_DEFAULT_AVATAR = "PARAM_CONFIG_KEY_PREFIX:DEFAULT_AVATAR";
    public static final String PARAM_KEY_BAG_PRICE = "PARAM_CONFIG_KEY_PREFIX:BAG_PRICE";

    public static final String OPERATION_DISCARD_ORDER = "OPERATION_DISCARD_ORDER";
    public static final String OPERATION_ORDER_MAKE = "OPERATION_ORDER_MAKE";
    public static final String OPERATION_DELIVER_ORDER = "OPERATION_DELIVER_ORDER";

    public static final String OPERATION_LUCKY_DRAW = "OPERATION_LUCKY_DRAW";
    public static final String OPERATION_SCRAP_PRODUCT = "OPERATION_SCRAP_PRODUCT";
    public static final String OPERATION_PLACE_STOCK_ORDER = "OPERATION_PLACE_STOCK_ORDER";
    public static final String OPERATION_TRANSFER_STOCK = "OPERATION_TRANSFER_STOCK";
    public static final String OPERATION_CHECK_STOCK = "OPERATION_CHECK_STOCK";
    public static final String OPERATION_AUDIT_PURCHASING_ORDER = "OPERATION_AUDIT_PURCHASING_ORDER";

    public static final String PARAM_KEY_POS_PRODUCT_LAST_UPDATE_TIME = "PARAM_KEY_POS_PRODUCT_LAST_UPDATE_TIME";
    public static final String CARD_COUPON_PREFIX = "CARD_COUPON_PREFIX-";
    public static final String CARD_COUPON_FOR_BUY = "CARD_COUPON_FOR_BUY";
    public static final String CARD_COUPON_FOR_GIVE = "CARD_COUPON_FOR_GIVE";
    public static final String PARAM_KEY_BATCH_SMS_REQUEST_URL = "PARAM_KEY_BATCH_SMS_REQUEST_URL";

    public static final String PARAM_KEY_SMS_NOTIFY_TEMPLATE_ID = "PARAM_KEY_SMS_NOTIFY_TEMPLATE_ID";
    public static final String PARAM_KEY_SMS_VCODE_TEMPLATE_ID = "PARAM_KEY_SMS_VCODE_TEMPLATE_ID";
    public static final String PARAM_KEY_SMS_NOTIFY_SMSID = "PARAM_KEY_SMS_NOTIFY_SMSID";

    public static final String PARAM_KEY_SMS_APP_KEY = "PARAM_KEY_SMS_APP_KEY";
    public static final String PARAM_KEY_SMS_API_SECRET = "PARAM_KEY_SMS_API_SECRET";
    ...
    public static final double[][] COLLECTIVE_SCORE_MATRIX = {
            {5.0, 5.0, 4.0,3.0},    // 省级及以上
            {5.0, 4.0, 3.0, 2.0},     // 福州市级
            {4.0, 3.0, 2.0, 1.5},      // 福清市级
            {1.5, 1.0, 0.5, 0.0}       // 校级
    };
